...
public class AnalyticsHelperMocks {
	...
	public static List<GenericValuesRecord> createSampleRecordList() {
		...
		records.add(new GenericValuesRecord(1L, LocalDateTime.of(2024, 12, 16, 7, 53), "0774693",
				"608384", "ALB2", "PCCC1", 3.45, 3.35, 0.2, "g/dL", "Average", "Approved"));

		records.add(new GenericValuesRecord(2L, LocalDateTime.of(2024, 12, 16, 7, 53), "0774707",
				"704991", "ALB2", "PCCC2", 4.85, 4.94, 0.3, "g/dL", "Average", "Approved"));

		// Failed records
		records.add(new GenericValuesRecord(3L, LocalDateTime.of(2024, 12, 16, 8, 30), "0774707",
				"704991", "ALTL", "PCCC2", 82.84, 110.0, 7.0, "U/L", "-3s", "Failed"));

		// Different analyte records
		records.add(new GenericValuesRecord(4L, LocalDateTime.of(2024, 12, 16, 7, 54), "0774707",
	...
	public static List<GenericValuesRecord> createMultiAnalyteRecordList() {
		...
		// ALTL record
		records.add(new GenericValuesRecord(2L, LocalDateTime.of(2024, 12, 16, 9, 02), "0774693",
				"608384", "ALTL", "PCCC1", 48.1, 46.8, 2.8, "U/L", "Average", "Approved"));

		// CHOL2 record
		records.add(new GenericValuesRecord(3L, LocalDateTime.of(2024, 12, 16, 7, 56), "0774693",
	...
	public static List<GenericValuesRecord> createDateRangeRecords() {
		...
		for (int i = 0; i < 5; i++) {
			records.add(new GenericValuesRecord((long) i + 1, baseDate.plusMinutes(i * 30),

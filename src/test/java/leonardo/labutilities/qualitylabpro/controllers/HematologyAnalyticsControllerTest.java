...
public class HematologyAnalyticsControllerTest {
        ...
        void analytics_post_return_201() throws Exception {
                ...
                mockMvc.perform(post("/hematology-analytics")
        ...
        void getAllAnalytics_return_list() throws Exception {
                List<GenericValuesRecord> records = createSampleRecordList();
                when(hematologyAnalyticsService.getAllByNameIn(anyList(), any()))
                                .thenReturn(records);
        ...
        void getAnalyticsByLevel_return_analytics() throws Exception {
                ...
                verify(hematologyAnalyticsService, times(1)).findAnalyticsByNameAndLevel(any(),
                                any(), any());
        }
        ...
        void getAnalyticsByDateRange_return_analytics() throws Exception {
                ...
                when(hematologyAnalyticsService.getAllByNameInAndDateBetween(anyList(), any(),
                ...
                verify(hematologyAnalyticsService, times(1)).getAllByNameInAndDateBetween(anyList(),
                                any(), any());
        }
        ...
        void getMeanAndStandardDeviation_return_result() throws Exception {
                ...
                when(hematologyAnalyticsService.calculateMeanAndStandardDeviation(any(), any(),

...
public class HematologyAnalyticsControllerTest {
    ...
    void getAnalyticsByLevel_return_analytics() throws Exception {
        ...
        verify(hematologyAnalyticsService, times(1)).findAnalyticsByNameAndLevel(any(), any(), any());
    }
    ...
    void getAnalyticsByDateRange_return_analytics() throws Exception {
        ...
        verify(hematologyAnalyticsService, times(1)).getAllByNameInAndDateBetween(anyList(), any(), any());
    }
    ...
    void getMeanAndStandardDeviation_return_result() throws Exception {
        ...
        verify(hematologyAnalyticsService, times(1)).calculateMeanAndStandardDeviation(any(), any(), any(), any());
    }
}

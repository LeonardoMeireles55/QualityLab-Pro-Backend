...
public class CoagulationAnalyticsControllerTest {
    ...
    void getAnalyticsByLevel_return_analytics() throws Exception {
        ...
        mockMvc.perform(get("/coagulation-analytics/results/search/name/level")
                        .param("name", "Glucose")
                        .param("level", "Normal")
                        .param("page", "0")
                        .param("size", "10"))
        ...
        verify(coagulationAnalyticsService, times(1)).findAnalyticsByNameAndLevel(any(), any(), any());
    }
    ...
    void getAnalyticsByDateRange_return_analytics() throws Exception {
        ...
        mockMvc.perform(get("/coagulation-analytics/results/names/date-range")
                        .param("startDate", "2025-01-01 00:00:00")
                        .param("endDate", "2025-01-05 00:00:00"))
                .andExpect(status().isOk());

        verify(coagulationAnalyticsService, times(1)).getAllByNameInAndDateBetween(anyList(), any(), any());
    }
    ...
    void getMeanAndStandardDeviation_return_result() throws Exception {
        ...
        when(coagulationAnalyticsService.calculateMeanAndStandardDeviation(any(), any(), any(), any()))
                .thenReturn(result);

        mockMvc.perform(get("/coagulation-analytics/results/mean-standard-deviation")
        ...
        verify(coagulationAnalyticsService, times(1)).calculateMeanAndStandardDeviation(any(), any(), any(), any());
    }
}

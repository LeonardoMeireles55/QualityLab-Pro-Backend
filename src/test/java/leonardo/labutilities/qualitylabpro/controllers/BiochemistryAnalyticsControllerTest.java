...
public class BiochemistryAnalyticsControllerTest {
        ...
        void getAllAnalytics_return_list() throws Exception {
                ...
                mockMvc.perform(get("/biochemistry-analytics").param("page", "0").param("size",
        ...
        void getAnalyticsByLevel_return_analytics() throws Exception {
                ...
                verify(biochemistryAnalyticsService, times(1)).findAnalyticsByNameAndLevel(any(),
                                any(), any());
        }
        ...
        void getAnalyticsByDateRange_return_analytics() throws Exception {
                ...
                when(biochemistryAnalyticsService.getAllByNameInAndDateBetween(anyList(), any(),
        ...
        void getMeanAndStandardDeviation_return_result() throws Exception {
                ...
                when(biochemistryAnalyticsService.calculateMeanAndStandardDeviation(any(), any(),
